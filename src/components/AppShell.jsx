...
export default function AppShell({ user, theme, children }) {
  ...
  return (
    <div className="min-h-screen lg:pl-64">
      ...
      {/* Mobile top bar */}
      <header className="safe-top sticky top-0 z-20 flex h-14 items-center gap-3 border-b border-white/10 bg-shell px-4 lg:hidden" style={{ height: 'calc(3.5rem + env(safe-area-inset-top))' }}>
        <button
